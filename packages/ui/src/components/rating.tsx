...
function StarIcon({ size = 24, strokeWidth = 1.5, ...props }: IconProps) {
  return (
    <svg
...
const RatingRoot = ({
  ...
  const renderIcon = (fill: number) => {
    const outline = icon ?? <StarIcon strokeWidth={1.5} />;
    const filled = filledIcon ?? <StarIcon strokeWidth={1.5} fill="currentColor" />;
