...
export default function NotFound() {
  ...
  const query = cleanSegment || 'doc';
  const filename = `${query}.mdx`;

  return (
    <Flex align="center" justify="center" className="relative min-h-[75vh] overflow-hidden py-24">
      <div
        aria-hidden="true"
        ...
        <div className="flex max-w-sm flex-col items-center space-y-6">
          ...
          <Flex align="center" justify="center" gap="3" className="w-full flex-wrap pt-2">
            ...
            <Button
              variant="default"
              size="sm"
              leftIcon={<HugeiconsIcon icon={Search02Icon} className="size-4" />}
