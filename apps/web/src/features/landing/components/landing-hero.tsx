...
export function LandingHero() {
  ...
  return (
    <section className="flex w-full flex-col items-center pt-4 text-center md:pt-6">
      <div className="landing-hero">
        ...
        <p className="section-label relative">{t('badge')}</p>
        <h1 className="font-heading text-foreground relative mt-4 max-w-3xl text-[1.75rem] leading-[1.1] font-semibold tracking-[-0.02em] md:text-[2rem] lg:text-[2.25rem]">
          {t('subheading1')}
        </h1>
        <p className="text-muted-strong relative mt-4 max-w-[54ch] text-[15px] leading-relaxed md:text-base">
          {t('description')}
        </p>
        <div className="relative mt-7 flex flex-wrap items-center justify-center gap-x-6 gap-y-3">
          <Link
